...
import { addProduct, allProduct, deleteProduct, getProduct, loginUser, registerUser, updateProduct } from '../controllers/userController.js';
...
userRouter.get('/get-products', authUser, allProduct);
